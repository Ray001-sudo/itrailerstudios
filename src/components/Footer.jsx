...
const CREDIT_ICON =
  'https://cdn.prod.website-files.com/68b441e1fde228bec9177841/68b474b9e4876ff3e99f741a_icon.svg'
          ...
          <div className="padding-vertical padding-xxlarge">
              ...
              <div className="w-layout-grid footer1_top-wrapper">
                <div className="footer1_left-wrapper">
                  <div className="margin-bottom margin-small">
                      <Logo className="footer1_logo" />
                  </div>
                </div>

                <div className="w-layout-grid footer1_menu-wrapper">
                  <div className="footer1_link-column">
                    ...
                    <div className="footer1_link-list">
                      {links.map((l) => (
                        <Link
                          ...
                          className={`footer1_link${pathname === l.href ? ' w--current' : ''}`}
                        >
                          {l.label}
                        </Link>
                      ))}
                  ...
                  <div id="w-node-_854b36cd-8c26-245d-4838-2dae2c7813ec-2c7813b2" className="footer1_link-column">
                    <div className="margin-bottom margin-xsmall">
                      <div className="text-weight-semibold">Stay Updated</div>
                    </div>
                    <div className="footer1_link-list">
                      <a
                        href="https://www.instagram.com/itrailerstudios/"
                        target="_blank"
                        rel="noreferrer"
                      ...
                      <a
                        href="https://www.linkedin.com/company/itrailerstudios/"
                        target="_blank"
                        rel="noreferrer"
                        className="footer1_social-link w-inline-block"
                      >
            ...
            <div className="padding-top padding-medium">
              <div className="footer1_bottom-wrapper">
                <div className="footer1_credit-text">© 2026 iTrailerStudios. All rights reserved.</div>
                <a href="mailto:bensonray25@gmail.com" target="_blank" rel="noreferrer" className="credit-div w-inline-block">
                  <div className="footer1_credit-text">Website by Ray</div>
                  <img src={CREDIT_ICON} loading="lazy" alt="" className="smalliconcredits" />
                </a>
              </div>
            </div>
          </div>
